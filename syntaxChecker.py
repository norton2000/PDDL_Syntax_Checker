...
ap.add_argument('-e', "--plan", "--execute", required=False, nargs='?', const='--search astar(lmcut())' ,help='Search for a plan with fast downward. Add all the options like --search after -e')
